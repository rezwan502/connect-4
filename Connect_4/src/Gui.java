...
//	static GamePlayer ai = new GamePlayer();
	...
	public static JLayeredPane createLayeredBoard() {
		...
		ImageIcon imageBoard = new ImageIcon("C:\\Users\\Md.Rezwanul Islam\\workspace\\Connect_4\\res\\images\\background.png");
	...
	public static void placeChecker(String color, int row, int col) {
		int xOffset = 75 * col;
		int yOffset = 75 * row;
		ImageIcon checkerIcon = new ImageIcon("C:\\Users\\Md.Rezwanul Islam\\workspace\\Connect_4\\res\\images\\" + color + ".gif");
